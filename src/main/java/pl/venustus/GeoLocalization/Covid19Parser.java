...
public class Covid19Parser {
    ...
    public static final String url = "https://github.com/CSSEGISandData/COVID-19/blob/master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_confirmed_US.csv";
    ...
    public List<Point> getCovidData() throws IOException {
        ...
        for (CSVRecord strings : parse) {
            ...
            double lat = Double.parseDouble(strings.get(9));
            double lon = Double.parseDouble(strings.get(11));
